const Benefits = () => {
  const benefits = [
    ...
    },
    {
      ...
      description: "Remote, hybrid, and flexible working arrangements"
    },
    {
      icon: (
        <svg className="w-8 h-8 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: "Training budgets, conference attendance, and mentorship programs"
    },
    {
      icon: (
        <svg className="w-8 h-8 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: "Generous PTO, parental leave, and flexible scheduling"
    }
  ];
      ...
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {benefits.map((benefit, index) => (
            <div key={index} className="bg-white dark:bg-gray-dark p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow">
