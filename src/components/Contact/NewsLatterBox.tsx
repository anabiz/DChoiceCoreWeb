  ...
  return (
    <div className="shadow-three dark:bg-gray-dark relative z-10 rounded-lg bg-white p-8 sm:p-11 lg:p-8 xl:p-11">
      ...
      <p className="border-body-color/25 text-body-color mb-11 border-b pb-11 text-base leading-relaxed dark:border-white/25">
        Get the latest updates on AI, cloud computing, cybersecurity, and digital transformation trends delivered to your inbox.
      </p>
      <div>
        <input
          type="text"
        ...
        <p className="text-body-color dark:text-body-color-dark text-center text-base leading-relaxed">
          We respect your privacy. No spam, just valuable technology insights.
        </p>
      </div>
        ...
        <span className="absolute top-7 left-2">
          ...
          >
            ...
            <defs>
              ...
              >
                <stop
                  stopColor={theme === "light" ? "#F35C7A" : "#fff"}
                  stopOpacity="0.62"
                />
                <stop
                  offset="1"
